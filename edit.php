...
<hr>
    ...
    <form action="", method="get" align="center" >
        ...
        <input type='hidden' name='id' value='<?php echo htmlspecialchars($row['id']); ?>'> <br>
                ...
                <div style="color: red;"><h6>Are you sure you want to Edit this Data</h6></div>
                
                <hr style="margin-top: 30px;">
                <input type="submit" name="submit" value="Update" style="width: 90px; height:25px;">
            </form>
    </div>
<?php
} else {  
...
&& isset($_GET['urdugrade'])
   ...
   echo "</font>
    ...
    ?>
    <br><br>
<div style="color: red;"><p>DATA HAS BEEN Updated SUCCESSFULLY</p></div>
    <?php
    ...
    gradeinenglish = '" . $_GET['englishgrade']. "',
    math = '" . $_GET['math']. "',
    gradeinmath = '" . $_GET['mathgrade']. "',
    urdu= '" . $_GET['urdu']. "',
    gradeinurdu= '" . $_GET['urdugrade']. "'
